...
const laCities = [
  ...
  'Pasadena', 'Torrance', 'El Monte', 'Inglewood', 'Pomona',
  'West Covina', 'Carson', 'Norwalk', 'Compton', 'Downey',
  'Costa Mesa', 'Anaheim', 'Santa Ana', 'Irvine', 'Fullerton',
  'Garden Grove', 'Huntington Beach', 'Fontana', 'Ontario', 'Rancho Cucamonga',
  'San Bernardino', 'Riverside', 'Corona', 'Moreno Valley', 'Oxnard',
]

const areas = [
  { name: 'Los Angeles County', desc: 'Downtown LA, Hollywood, Santa Monica, Pasadena, and the sprawling LA metro core.' },
  { name: 'San Fernando Valley', desc: 'Burbank, Glendale, Van Nuys, Sherman Oaks, and the Valley\'s dense business corridor.' },
  { name: 'South Bay', desc: 'Long Beach, Torrance, Carson, Hawthorne, and the coastal south LA communities.' },
  { name: 'East LA & San Gabriel Valley', desc: 'East Los Angeles, El Monte, Pomona, West Covina, and the San Gabriel Valley.' },
  { name: 'Orange County', desc: 'Anaheim, Santa Ana, Irvine, Fullerton, and the broader OC business community.' },
]

const services = [
  { title: 'Custom Website Design', desc: 'Mobile-first, SEO-ready websites built around your Los Angeles business goals. Launched in 10–15 business days.', href: '/services/design', accent: '#5636D1' },
  { title: 'Local SEO Optimization', desc: 'Rank for "web design Los Angeles" and location-specific searches. Built-in schema markup and Google-ready structure.', href: '/services/seo', accent: '#E2498A' },
...
const faqs = [
  { q: 'Do you work with businesses physically located in Los Angeles?', a: 'Yes. We serve LA businesses across Los Angeles County, Orange County, the Inland Empire, and Ventura County. All work is done remotely — we handle everything online, from kickoff to launch.' },
  { q: 'How much does a website cost for a Los Angeles small business?', a: 'Starter is $39/month, Business is $69/month, and Virtual Employee is $149/month. Normal setup fees are currently waived; see the pricing page for each plan\'s inclusions.' },
  { q: 'Will my website rank for LA-specific searches?', a: 'Every site includes basic SEO setup. Business and Virtual Employee also include SEO optimization for location-specific searches.' },
  { q: 'How quickly can my LA business get online?', a: 'Most sites are designed and launched within 10–15 business days after you submit your content and preferences. We handle design, development, hosting setup, and launch — you just review and approve.' },
]
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Los Angeles Web Design', item: 'https://www.affordawebsolutions.com/los-angeles' },
  ],
}
...
const localBusinessSchema = {
  ...
  description: 'Affordable website design for Los Angeles small businesses starting at $39/month.',
  areaServed: [
    ...
    { '@type': 'City', name: 'Glendale', containedInPlace: { '@type': 'State', name: 'California' } },
    ...
    <>
      ...
      <section className="relative overflow-hidden pt-[200px] pb-[100px] text-center" style={{ background: '#0F0F1A' }}>
        ...
        <div className="container-tight relative z-10">
          <p className="section-label-white">Los Angeles</p>
          <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6" style={{ letterSpacing: '-0.025em' }}>
            Affordable Web Design<br className="hidden sm:block" /> for Los Angeles Small Businesses
          </h1>
          <p className="text-lg max-w-2xl mx-auto mb-8" style={{ color: 'rgba(255,255,255,0.55)' }}>
            Professional websites for LA businesses starting at <strong className="text-white">$39/month</strong> — custom design, hosting, and SSL bundled into one plan. Normal setup fees are currently waived.
          </p>
          <div className="flex flex-wrap justify-center gap-2 mb-8">
            {['LA County', 'San Fernando Valley', 'South Bay', 'Orange County', 'Inland Empire'].map(label => (
      ...
      <section className="section-pad bg-white" aria-labelledby="la-services-heading">
        <div className="container-tight">
          <div className="text-center mb-14">
            <p className="section-label">What We Offer Los Angeles Businesses</p>
            <h2 id="la-services-heading" className="section-title">Everything Your Los Angeles Business Needs Online</h2>
            <p className="text-gray-500 mt-4 max-w-2xl mx-auto">From custom website design to local SEO and managed hosting — all bundled into one affordable monthly plan built for Los Angeles small businesses.</p>
          </div>
      ...
      <section className="section-pad relative overflow-hidden" style={{ background: '#0F0F1A' }}>
        ...
        <div className="container-tight relative z-10">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4" style={{ letterSpacing: '-0.02em' }}>Serving All of Greater Los Angeles</h2>
            <p className="text-base max-w-xl mx-auto" style={{ color: 'rgba(255,255,255,0.45)' }}>We work remotely with LA businesses across every county. If you&rsquo;re in Greater Los Angeles, we can build your website.</p>
          </div>
          ...
          <div className="text-center">
            <p className="text-sm font-semibold mb-4" style={{ color: 'rgba(255,255,255,0.4)', letterSpacing: '0.08em', textTransform: 'uppercase' }}>Cities & Areas We Serve</p>
        ...
        <div className="container-tight">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 id="la-why-heading" className="section-title mb-6">The Affordable Option for LA Small Businesses</h2>
              <p className="text-gray-500 leading-relaxed mb-4">Most Los Angeles web design agencies charge $3,000–$10,000 upfront. AffordaWeb plans start at <Link href="/pricing" className="text-primary-600 font-medium hover:underline">$39/month</Link>.</p>
              <p className="text-gray-500 leading-relaxed mb-6">Every site includes local SEO setup so your business can rank for searches like &ldquo;affordable web design Los Angeles&rdquo; or &ldquo;[your service] near me.&rdquo; We build the structure Google rewards, from day one.</p>
      ...
      <section className="section-pad relative overflow-hidden" style={{ background: '#0F0F1A' }}>
        ...
        <div className="container-tight max-w-3xl relative z-10">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4" style={{ letterSpacing: '-0.02em' }}>Los Angeles Web Design FAQ</h2>
          </div>
      ...
      <section className="section-pad relative overflow-hidden" style={{ background: '#0F0F1A' }}>
        ...
        <div className="container-tight relative z-10 text-center">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6" style={{ letterSpacing: '-0.025em' }}>Let&rsquo;s Build Your Los Angeles Business Website</h2>
          <p className="text-lg max-w-2xl mx-auto mb-10" style={{ color: 'rgba(255,255,255,0.55)' }}>Tell us about your LA business and we&rsquo;ll have your professional website live in 10–15 days. No upfront cost, no contracts.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">

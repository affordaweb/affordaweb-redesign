...
const posts = [
  ...
  },
  {
    ...
    excerpt:
      "Agency quotes, DIY builders, and subscription services all charge very different amounts. Here's an honest breakdown of website costs so you can make the right call for your business.",
    category: 'Pricing',
    date: 'November 15, 2025',
    readTime: '7 min read',
    image: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=600&auto=format&fit=crop&q=80',
    imageAlt: 'Calculator and laptop for calculating website design costs',
    featured: false,
    accent: '#10B981',
    accentLight: 'rgba(16,185,129,0.10)',
    accentBorder: 'rgba(16,185,129,0.22)',
  ...
  },
  {
    ...
    imageAlt: 'Comparison of web design platforms for small businesses',
    featured: false,
    accent: '#E2498A',
    accentLight: 'rgba(226,73,138,0.10)',
    accentBorder: 'rgba(226,73,138,0.22)',
...
const categories = ['All', 'Web Design', 'SEO', 'Business Growth', 'Pricing', 'Performance', 'Maintenance', 'Web Maintenance']

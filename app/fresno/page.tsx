...
const fresnoCities = [
  'Clovis', 'Madera', 'Sanger', 'Selma', 'Reedley', 'Kingsburg',
  'Fowler', 'Kerman', 'Dinuba', 'Hanford', 'Visalia', 'Tulare',
  'Porterville', 'Merced', 'Modesto', 'Tower District', 'Fig Garden',
  'Woodward Park', 'Bullard', 'River Park', 'Northwest Fresno',
  'Old Town Clovis', 'Copper River Ranch', 'Granville', 'Sunnyside',
  'McLane', 'Fig Garden Village', 'Easton', 'Coalinga', 'Lemoore',
]

const areas = [
  { name: 'Central Fresno', desc: 'Downtown Fresno, Tower District, and the core business corridor.' },
  { name: 'North Fresno & Clovis', desc: 'Rapidly growing suburbs with high-density retail and professional services.' },
  { name: 'Southeast Fresno', desc: 'Sunnyside, Sanger, Reedley, and surrounding agricultural communities.' },
  { name: 'West Fresno & Kerman', desc: 'Agricultural business hubs and small businesses along the west side.' },
  { name: 'Madera County', desc: 'Communities north of Fresno including Madera and Chowchilla.' },
  { name: 'Kings & Tulare Counties', desc: 'Hanford, Visalia, Tulare, and surrounding South Valley towns.' },
]

const services = [
  {
    title: 'Custom Website Design',
    desc: 'Mobile-first, SEO-ready websites built around your Fresno business goals. Launched in 10–15 business days.',
    href: '/services/design',
    accent: '#5636D1',
  },
  {
    title: 'Local SEO Optimization',
    desc: 'Rank for "web design Fresno" and location-specific searches. Built-in schema markup and Google-ready structure.',
    href: '/services/seo',
    accent: '#E2498A',
  },
  {
    title: 'Website Hosting & SSL',
    desc: 'Managed hosting with guaranteed uptime, free SSL, and 1GB professional email — all included in your plan.',
...
const faqs = [
  {
    q: 'Do you work with businesses physically located in Fresno, CA?',
    a: 'Yes. We serve Fresno businesses across the entire Central Valley — Clovis, Madera, Sanger, Hanford, Visalia, and beyond. All work is done remotely and we handle everything online, from kickoff to launch.',
  },
  {
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Fresno Web Design', item: 'https://www.affordawebsolutions.com/fresno' },
  ],
}
    ...
    <>
      ...
      <section className="relative overflow-hidden pt-[200px] pb-[100px] text-center" style={{ background: '#0F0F1A' }}>
        ...
        <div className="container-tight relative z-10">
          <p className="section-label-white">Fresno, California</p>
      ...
      {/* Services */}
      <section className="section-pad bg-white" aria-labelledby="fresno-services-heading">
        <div className="container-tight">
          <div className="text-center mb-14">
            <p className="section-label">What We Offer Fresno Businesses</p>
            <h2 id="fresno-services-heading" className="section-title">
              Everything Your Fresno Business Needs Online
            </h2>
            <p className="text-gray-500 mt-4 max-w-2xl mx-auto">
              From custom website design to local SEO and managed hosting — all bundled into one affordable monthly plan built for Fresno and Central Valley small businesses.
            </p>
          </div>
        ...
        <div className="container-tight relative z-10">
          <div className="text-center mb-14">
            ...
            <p className="text-base max-w-xl mx-auto" style={{ color: 'rgba(255,255,255,0.45)' }}>
              We work remotely with businesses across Fresno, Clovis, Madera, Hanford, Visalia, and every corner of the Central Valley.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-12">
            {areas.map(({ name, desc }, i) => {
              const colors = ['#5636D1','#E2498A','#06B6D4','#F59E0B','#10B981','#8B5CF6']
        ...
        <div className="container-tight">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 id="fresno-why-heading" className="section-title mb-6">
      ...
      <section className="section-pad relative overflow-hidden" style={{ background: '#0F0F1A' }}>
        ...
        <div className="container-tight relative z-10 text-center">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6" style={{ letterSpacing: '-0.025em' }}>
            Let&rsquo;s Build Your Fresno Business Website
          </h2>
          <p className="text-lg max-w-2xl mx-auto mb-10" style={{ color: 'rgba(255,255,255,0.55)' }}>
            Tell us about your Fresno business and we&rsquo;ll have your professional website live in 10–15 days. No upfront cost, no contracts.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">

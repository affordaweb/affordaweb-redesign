...
export default function ContactPage() {
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="card bg-gradient-to-br from-primary-50 to-primary-100/40 border-primary-100">
                ...
                <h3 className="font-bold text-dark mb-1">24-Hour Response</h3>
                <p className="text-gray-500 text-sm leading-relaxed">
              ...
              {/* Reasons */}
              <div>
                <h3 className="font-semibold text-dark mb-4 text-sm uppercase tracking-widest">
            ...
            <div className="lg:col-span-3">
              <div className="card shadow-card-hover">
                ...
                >
                  ...
                  <div>
                    <label htmlFor="website" className="block text-sm font-semibold text-dark mb-2">
      ...
      {/* Plans reminder */}
      <section className="section-pad bg-white border-t border-gray-100" aria-label="Pricing reminder">
